  ...
  <el-card class="box-card" shadow="hover">
    ...
    <template #header>
      <div class="card-header">
        <span class="title">SunlightInput 组件示例及属性文档</span>
      </div>
    </template>
    ...
    <div class="display-wrapper">
      ...
      <p class="text-content" v-if="text">{{ text }}</p>
      <p class="text-placeholder" v-else>暂无输入内容</p>
    </div>

    <div class="display-wrapper">
      <span class="label">当前键盘事件：</span>
      <p class="text-content" v-if="keyboardEvent">{{ keyboardEvent }}</p>
      <p class="text-placeholder" v-else>暂无输入内容</p>
    </div>
