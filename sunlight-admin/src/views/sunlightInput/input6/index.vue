  ...
  <el-card class="box-card" shadow="hover">
    ...
    <template #header>
      <div class="card-header">
        <span class="title">SunlightInput 插槽按钮示例及属性文档</span>
      </div>
    </template>

    <!-- 插槽按钮使用示例 -->
    <div class="input-box">
      <SunlightInput v-model="value" :item="inputItem">
        <template #prepend>
          <el-button @click="onPrependClick">前置按钮</el-button>
        </template>
        <template #append>
          <el-button @click="onAppendClick">后置按钮</el-button>
        </template>
      </SunlightInput>
    </div>
