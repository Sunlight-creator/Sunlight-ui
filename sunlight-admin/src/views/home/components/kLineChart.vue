  ...
  if (isMultipleSeries.value) {
    ...
    return multiData.map((item, index) => {
      ...
      return {
        name: item.name,
        type: 'candlestick',
        data: item.data.map(klineItem => [klineItem.open, klineItem.close, klineItem.low, klineItem.high]),
        itemStyle: {
          color: '#ef5350',
          color0: '#66bb6a',
          borderColor: '#ef5350',
    ...
    return [
      {
        name: 'K线',
        type: 'candlestick',
        data: singleData.map(klineItem => [klineItem.open, klineItem.close, klineItem.low, klineItem.high]),
        itemStyle: {
          color: '#ef5350',
          color0: '#66bb6a',
          borderColor: '#ef5350',
