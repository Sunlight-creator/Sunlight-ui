<template>
  <el-card class="box-card" shadow="hover">
    <div class="card-header">
      <span class="title">SunlightRadio 自定义颜色样式示例</span>
    </div>

    <el-divider>默认样式（蓝色主题）</el-divider>
...
const greenValue = ref('b')
const blueValue = ref('c')
const orangeValue = ref('a')
const redValue = ref('b')
const roundedValue = ref('c')
...

{
  ...
  focusBoxShadowColor: 'rgba(64, 158, 255, 0.1)'  // 聚焦时内阴影颜色（默认：蓝色半透明）
}
...
:item="{
  wrapperStyle: {
    ...
    focusBoxShadowColor: 'rgba(103, 194, 58, 0.1)', // 聚焦时绿色阴影
