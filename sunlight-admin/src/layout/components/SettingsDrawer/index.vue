<template>
  <el-drawer v-model="drawerVisible" :title="$t('setting.drawerTitle')" size="300px">
    ...
    <el-divider class="divider" content-position="center">
      ...
      <span class="divider-text">{{ $t('setting.menuStyleTitle') }}</span>
    </el-divider>
    <div class="menu-style-box mb30">
      <el-tooltip effect="dark" content="默认风格" placement="top" :show-after="200">
        <div
          :class="['menu-style-item menu-style-default', { 'is-active': menuStyle == 'default' }]"
          @click="setMenuStyle('default')"
        >
          <div class="menu-item menu-item-dark"></div>
          <div class="menu-item menu-item-light"></div>
          <div class="menu-item menu-item-light"></div>
          <el-icon v-if="menuStyle == 'default'" class="check-icon"><CircleCheckFilled /></el-icon>
        </div>
      </el-tooltip>
      <el-tooltip effect="dark" content="暗色风格" placement="top" :show-after="200">
        <div
          :class="['menu-style-item menu-style-dark', { 'is-active': menuStyle == 'dark' }]"
          @click="setMenuStyle('dark')"
        >
          <div class="menu-item menu-item-dark"></div>
          <div class="menu-item menu-item-dark"></div>
          <div class="menu-item menu-item-dark"></div>
          <el-icon v-if="menuStyle == 'dark'" class="check-icon"><CircleCheckFilled /></el-icon>
        </div>
      </el-tooltip>
      <el-tooltip effect="dark" content="浅色风格" placement="top" :show-after="200">
        <div
          :class="['menu-style-item menu-style-light', { 'is-active': menuStyle == 'light' }]"
          @click="setMenuStyle('light')"
        >
          <div class="menu-item menu-item-light"></div>
          <div class="menu-item menu-item-light"></div>
          <div class="menu-item menu-item-light"></div>
          <el-icon v-if="menuStyle == 'light'" class="check-icon"><CircleCheckFilled /></el-icon>
        </div>
      </el-tooltip>
    </div>
  </el-drawer>
...
const { layout, primary, isDark, breadcrumb, breadcrumbIcon, tabs, tabsIcon, footer, menuStyle } =
...
// 设置菜单风格
const setMenuStyle = (val: any) => {
  globalStore.setGlobalState('menuStyle', val)
}
